...
struct AuraDamageStatics{
	DECLARE_ATTRIBUTE_CAPTUREDEF(Armor); //skrót do tworzenia zmiennych podbnyh do MMC_MaxHealth.h/.cpp
	...
	AuraDamageStatics(){
		DEFINE_ATTRIBUTE_CAPTUREDEF(UAuraAttributeSet, Armor, Target, false); //pobieramy armor targetu uderzenia
...
UExecCalc_Damage::UExecCalc_Damage(){
	RelevantAttributesToCapture.Add(DamageStatics().ArmorDef); //ArmorDef stworzony przez makra wyżej
...
void UExecCalc_Damage::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const{
	...
	//TODO: Tutaj można użyć różne algorytmy do obliczania w rozny sposob zależności pomiędzy parametrami
